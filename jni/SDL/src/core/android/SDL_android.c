...
void SDL_Android_Init(JNIEnv* mEnv, jclass cls)
{
    ...
    if(!midGetNativeSurface)
        __android_log_print(ANDROID_LOG_WARN, "SDL", "SDL: midGetNativeSurface: Couldn't locate Java callbacks, check that they're named and typed correctly");
    if(!midFlipBuffers)
        __android_log_print(ANDROID_LOG_WARN, "SDL", "SDL: midFlipBuffers: Couldn't locate Java callbacks, check that they're named and typed correctly");
    if(!midAudioInit)
        __android_log_print(ANDROID_LOG_WARN, "SDL", "SDL: midAudioInit: Couldn't locate Java callbacks, check that they're named and typed correctly");
    if(!midAudioWriteShortBuffer)
        __android_log_print(ANDROID_LOG_WARN, "SDL", "SDL: midAudioWriteShortBuffer: Couldn't locate Java callbacks, check that they're named and typed correctly");
    if(!midAudioWriteByteBuffer)
        __android_log_print(ANDROID_LOG_WARN, "SDL", "SDL: midAudioWriteByteBuffer: Couldn't locate Java callbacks, check that they're named and typed correctly");
    if(!midAudioQuit)
        __android_log_print(ANDROID_LOG_WARN, "SDL", "SDL: midAudioQuit: Couldn't locate Java callbacks, check that they're named and typed correctly");
    if(!midPollInputDevices)
        __android_log_print(ANDROID_LOG_WARN, "SDL", "SDL: midPollInputDevices: Couldn't locate Java callbacks, check that they're named and typed correctly");
